...
#' Initialize network
n = c(2, 3, 3, 1) # Nodes per layer (and input)
...
backpropagation_3 <- function(Y_hat, Y, m, A_2, W_3){
  A_3 <- Y_hat
  ...
  return(list(dC_dW3 = dC_dW3, dC_dB3 = dC_dB3, dC_dA2 = dC_dA2))
}

backpropagation_2 <- function(dC_dA2, A_1, A_2, W_2){
  ...
  return(list(dC_dW2 = dC_dW2, dC_dB2 = dC_dB2, dC_dA1 = dC_dA1))
}
  
backpropagation_1 <- function(dC_dA1, A_1, A_0, W_1){
  ...
  return(list(dC_dW1 = dC_dW1, dC_dB1 = dC_dB1))
}
  
# bp3 <- backpropagation_3(Y_hat = Y_hat$Y_hat, Y = Y, m = m, A_2 = Y_hat$hidden$A_2, W_3 = W$W_3) 
# bp2 <- backpropagation_2(dC_dA2 = bp3$dC_dA2, A_1 = Y_hat$hidden$A_1, A_2 = Y_hat$hidden$A_2, W_2 = W$W_2) 
# bp1 <- backpropagation_1(dC_dA1 = bp2$dC_dA1, A_1 = Y_hat$hidden$A_1, A_0 = A_0, W_1 = W$W_1) 
...
for(epoch in 1:epochs){
  ...
  # Update weights
  W$W_3 <- W$W_3 - (lr * bp3$dC_dW3)
  W$W_2 <- W$W_2 - (lr * bp2$dC_dW2)
  W$W_1 <- W$W_1 - (lr * bp1$dC_dW1)
  
  # Update biases
  B$B_3 <- B$B_3 - (lr * bp3$dC_dB3)
  B$B_2 <- B$B_2 - (lr * bp2$dC_dB2)
  B$B_1 <- B$B_1 - (lr * bp1$dC_dB1)
